...
class Alphabet extends FlxSpriteGroup
{
	...
	public var textColor(default, set):FlxColor = FlxColor.BLACK;
	...
	public function new(x:Float, y:Float, text:String = "", ?bold:Bool = false, typed:Bool = false, ?typingSpeed:Float = 0.05, ?textSize:Float = 1, ?textColor:FlxColor = FlxColor.BLACK)
	{
		super(x, y);
