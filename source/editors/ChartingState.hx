...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Plane Swap', "Place where the plane should leave"],
		['Alien Hominid', "Starts moving Alien Hominid to random coordinates \nShould be used only in \"fourside\" Stage! \n Value 1: Number of times Alien Hominid should move"]
	];
